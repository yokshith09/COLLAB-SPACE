...
export default function SignInPage() {
  return (
    <section className="min-h-[calc(100dvh-4rem)] bg-background px-4 py-10 text-foreground sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100dvh-9rem)] w-full max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="w-full rounded-xl border border-border bg-card p-6 shadow-xl shadow-slate-200 sm:p-8">
          <div className="mb-8">
