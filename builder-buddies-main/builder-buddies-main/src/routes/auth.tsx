...
export const Route = createFileRoute("/auth")({
  ssr: false,
  head: () => ({ meta: [{ title: "Sign in — CollabSpace" }] }),
  component: AuthPage,
});
  ...
  return (
    <div className="min-h-screen grid place-items-center px-4 bg-background">
      <div className="w-full max-w-sm space-y-6">
        <Link to="/" className="flex items-center gap-2 font-bold text-lg justify-center">
        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{mode === "signin" ? "Sign in to continue building." : "Build in public. Find your team."}</p>
          </div>
          ...
          <form onSubmit={handleEmail} className="space-y-3">
            ...
            <div className="space-y-2"><Label htmlFor="pw">Password</Label><Input id="pw" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} /></div>
